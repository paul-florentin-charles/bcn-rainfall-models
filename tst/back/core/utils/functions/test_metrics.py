...
class TestMetrics:
    ...
    def test_get_average_rainfall():
        precision = 3
        avg_rainfall = metrics.get_average_rainfall(YEARLY_RAINFALL.data, round_precision=precision)
    ...
    def test_get_years_compared_to_given_rainfall_value():
        nb_years = metrics.get_years_compared_to_given_rainfall_value(
            YEARLY_RAINFALL.data, metrics.get_average_rainfall(YEARLY_RAINFALL.data), comparator=lt
        )
